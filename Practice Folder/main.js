...
console.log(addNums(5, 7));//this is a function. Functions have a few key points: 1. When creating one you are always creating a variable, 2. the structure of a function is (function variable (parameters){logic}), 3. you can add upto 3 parameters in a function, 4. you must always add a return syntax if you want to get the logic to work, and you can do console.log outside the function, 5. to add values to the parameters, you can either add them inside the parameters like num1 = 1, but the correct way to add values is when you are calling the function like console.log(addNums(5, 7)), this will replace the num1 with 5 and num2 with 7.   


// function games(game1, game2, game3) {
//   console.log(`I like to play ${game1}, but when I get broad of ${game1} I play ${game2}, but sometimes I don't want to play any, so I just play ${game3} games.`);
// }

// games("Marvel Rivals", "Overwatch 2", "RPG");